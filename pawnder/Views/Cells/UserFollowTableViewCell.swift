...
protocol UserFollowTableViewCellDelegate: AnyObject{
    func didTapFollowUnfolloweButton(model: UserRelationship)
}
...
class UserFollowTableViewCell: UITableViewCell {
    ...
    @objc private func didTapFollowButton(){
        ...
        delegate?.didTapFollowUnfolloweButton(model: model)
    }
    public func configure(with model: UserRelationship){
        ...
        case .following:
            ...
            followButton.layer.borderColor = Constants.Design.Color.pawnderColor.cgColor
        case .not_following:
            //show follow button
            followButton.setTitle("Follow", for: .normal)
            followButton.setTitleColor(.white, for: .normal)
            followButton.backgroundColor = Constants.Design.Color.pawnderColor
            followButton.layer.borderWidth = 1
            followButton.layer.borderColor = Constants.Design.Color.pawnderColor.cgColor
        }
    }
